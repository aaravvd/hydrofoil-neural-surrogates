...
\item {\bf Limitations}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Section 5 discusses simulator fidelity, the single training seed, geometry scope, direct force supervision, and limited CFD revalidation.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Open access to data and code}
    ...
    \item[] Justification: The repository is organized for release, but an anonymized archival URL has not yet been inserted in this draft.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Experimental setting/details}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Sections 2--3 give the deterministic split, seed, optimizer, learning rate, model sizes, stopping rule, and design bounds.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer \answerNA{} means that the paper does not include experiments.
...
\item {\bf Experiment statistical significance}
    ...
    \item[] Answer: \answerNo{}
    \item[] Justification: Models were trained with one fixed seed; the paper reports per-case held-out metrics and explicitly identifies repeated-seed analysis as future work.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer \answerNA{} means that the paper does not include experiments.
...
\item {\bf Licenses for existing assets}
    ...
    \item[] Answer: \answerNo{}
    \item[] Justification: OpenFOAM and prior architectures are cited, but explicit software-license text remains to be added to the artifact documentation.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf New assets}
    ...
    \item[] Answer: \answerNo{}
    \item[] Justification: The generated dataset, checkpoints, and scripts are documented locally, but the anonymized release and final license are not yet attached to this draft.
    \item[] Guidelines:
    \begin{itemize}
