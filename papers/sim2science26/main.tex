...
\caption{Top: starts (dashed) and selected shapes. Bottom left: surrogate
predictions, CFD endpoint checks, and direct CFD. Bottom right: direct-CFD
convergence from all three starts.}
